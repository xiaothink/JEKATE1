...
var Comment1 = generateInvisible() + '#DIVA4D (PANGNANZ) = 10*41*78' + generateInvisible();

var namagroup2 = 'OMA CUAN';
var Comment2 = generateInvisible() + '#OMASLOT (OMANANZ) : 14*89 BETTING' + generateInvisible();

var namagroup3 = 'ROOM LOMBA 2D🟢';
var Comment3 = generateInvisible() + '#IDTOGEL*LINGKARAN*05*48*90' + generateInvisible();

var namagroup4 = 'G41B';
var Comment4 = generateInvisible() + 'GAIB4D=GIBBIG=05*48*90' + generateInvisible();

var namagroup5 = 'G1LA 4D GRUP';
var Comment5 = generateInvisible() + 'GILA4D=YGNOLIJ=05*48*90' + generateInvisible();

var namagroup6 = '453P VIP';
var Comment6 = generateInvisible() + 'ASEPTOGEL LABINAH 23*68*82' + generateInvisible();

var namagroup7 = 'VESPA7093L';
var Comment7 = generateInvisible() + 'VESPATOGEL (8KURANG8) 23*68*82' + generateInvisible();

var namagroup8 = 'MAYAPADA';
var Comment8 = generateInvisible() + 'BETT*Mayapada4D(BO)*SINGNANZ*65*08*64' + generateInvisible();

var namagroup9 = 'Lomba Hoho';
var Comment9 = generateInvisible() + 'OMANANZ : 08*64*65 #HOHOTOGEL' + generateInvisible();

var namagroup10 = 'OFFICIAL GOHT0G3L';
var Comment10 = generateInvisible() + 'GOHTOGEL=SOMERT=08*64*65' + generateInvisible();

var namagroup11 = 'SAHABAT';
var Comment11 = generateInvisible() + 'K86TOTO ( LINGKARAN ) : 22*31*47' + generateInvisible();

var namagroup12 = 'BUKU MIMPI 4D';
var Comment12 = generateInvisible() + 'IYATOTO PAIYAHTO 22*31*47' + generateInvisible();

var namagroup13 = 'HITO GROUP';
var Comment13 = generateInvisible() + '#HITOGEL HITMANZ99 04*49*72' + generateInvisible();

var namagroup14 = 'NEMO4D';
var Comment14 = generateInvisible() + 'NEMO4D (MUJAHIR) : 14*06*76' + generateInvisible();

var namagroup15 = 'GRUB LOMBA TGL123';
var Comment15 = generateInvisible() + 'TOGEL123 (POLJEMZ) 15*50*62*22*21' + generateInvisible();

var namagroup16 = 'TAFSIR MIMPI';
var Comment16 = generateInvisible() + 'SIJITOGEL SUDARNA 15*50*62' + generateInvisible();

var namagroup17 = 'MASTER KUY';
var Comment17 = generateInvisible() + 'TOGELKUY TERKUKUY 04*49*72' + generateInvisible();

var namagroup18 = '𝐕𝐈𝐏 𝐆𝐑𝐔𝐁 𝐀𝐋𝐋𝐏𝐀𝐒';
var Comment18 = generateInvisible() + 'Tok99Toto ( ARTKELE ) : 10*41*78' + generateInvisible();

var namagroup19 = 'group99';
var Comment19 = generateInvisible() + 'komen19' + generateInvisible();

var namagroup20 = 'VIDEO LUCUCU';
var Comment20 = generateInvisible() + 'komen2222' + generateInvisible();

var namagroup21 = 'GRUP ANGKER KOMUNITAS';
var Comment21 = generateInvisible() + 'ANGKER4D=SUODLA=15*50*62' + generateInvisible();

var namagroup22 = 'GRUP KIOST0T0 KOMUNITAS';
var Comment22 = generateInvisible() + 'KIOSTOTO=SOIKNAN=15*50*62' + generateInvisible();

var namagroup23 = 'Official shio';
var Comment23 = generateInvisible() + '#shiokelinci4d*KINANSI*14*89' + generateInvisible();
