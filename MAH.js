...
// @updateURL    https://raw.githubusercontent.com/xiaothink/JEKATE1/main/MAH.js
// @downloadURL  https://raw.githubusercontent.com/xiaothink/JEKATE1/main/MAH.js
// @author       You
// @match        http*://*/*
// @run-at       document-end
...
var Comment1 = generateInvisible() + '#DIVA4D (PAMAHRAN) = 27*67*96' + generateInvisible();

var namagroup2 = 'RIATOTO KIN9DOM';
var Comment2 = generateInvisible() + '#RIATOTO RIAROHA = 27*67*96' + generateInvisible();

var namagroup3 = 'ROOM LOMBA 2D🟢';
var Comment3 = generateInvisible() + '#IDTOGEL*TERNODA38*35*60*74' + generateInvisible();

var namagroup4 = 'G41B 4D GROUP';
var Comment4 = generateInvisible() + 'GAIB4D=BELEBER=35*60*74' + generateInvisible();

var namagroup5 = 'G1LA 4D GRUP';
var Comment5 = generateInvisible() + 'GILA4D=GABRIL=35*60*74' + generateInvisible();

var namagroup6 = '453P VIP';
var Comment6 = generateInvisible() + 'ASEPTOGEL FREDRIN 28*40*94' + generateInvisible();

var namagroup7 = 'VESPA7093L';
var Comment7 = generateInvisible() + 'VESPATOGEL (MEDUSA29) 28*40*94' + generateInvisible();

var namagroup8 = 'MAYAPADA GROUP';
var Comment8 = generateInvisible() + 'BETT*Mayapada4D(BO)*SAPULIDI*12*66*83' + generateInvisible();

var namagroup9 = 'Lomba Hoho';
var Comment9 = generateInvisible() + 'POLJEMZ : 12*66*83 #HOHOTOGEL' + generateInvisible();

var namagroup10 = 'OFFICIAL GOHT0G3L';
var Comment10 = generateInvisible() + 'GOHTOGEL=BOTUNA=12*66*83' + generateInvisible();

var namagroup11 = 'SAHABAT';
var Comment11 = generateInvisible() + 'K86TOTO ( NODAHITAM ) : 13*46*70' + generateInvisible();

var namagroup12 = 'BUKU MIMPI 4D';
var Comment12 = generateInvisible() + 'IYATOTO IYANTOTOH 13*46*70' + generateInvisible();

var namagroup13 = 'OMA CUAN';
var Comment13 = generateInvisible() + '#OMASLOT (SHISULIT) : 02*97 BETTING' + generateInvisible();

var namagroup14 = 'NEMO4D';
var Comment14 = generateInvisible() + 'NEMO4D (OMENEMO) : 02*42*98' + generateInvisible();

var namagroup15 = 'GRUB LOMBA TGL123';
var Comment15 = generateInvisible() + 'TOGEL123 (BELEBER) 19*57*84*25*51' + generateInvisible();

var namagroup16 = 'TAFSIR MIMPI';
var Comment16 = generateInvisible() + 'SIJITOGEL BELEBER 19*57*84' + generateInvisible();

var namagroup17 = 'MASTER KUY';
var Comment17 = generateInvisible() + 'TOGELKUY MEDUSA 34*58*71' + generateInvisible();

var namagroup18 = '𝐕𝐈𝐏 𝐆𝐑𝐔𝐁 𝐀𝐋𝐋𝐏𝐀𝐒';
var Comment18 = generateInvisible() + 'Tok99Toto ( ALICROT ) : 27*67*96' + generateInvisible();

var namagroup19 = 'HITO GROUP';
var Comment19 = generateInvisible() + '#HITOGEL SUSANO 34*58*71' + generateInvisible();

var namagroup20 = 'VIDEO LUCUCU';
var Comment20 = generateInvisible() + 'Komen4444' + generateInvisible();

var namagroup21 = 'GRUP ANGKER KOMUNITAS';
var Comment21 = generateInvisible() + 'ANGKER4D=ERIKSON=57*19*84' + generateInvisible();

var namagroup22 = 'GRUP KIOST0T0 KOMUNITAS';
var Comment22 = generateInvisible() + 'KIOSTOTO=ERIKSON=57*19*84' + generateInvisible();

var namagroup23 = 'Official shio';
var Comment23 = generateInvisible() + '#shiokelinci4d*SIMAHI*02*97' + generateInvisible();

var namagroup24 = 'groupp24';
var Comment24 = generateInvisible() + 'komen24' + generateInvisible();

var namagroup25 = 'groupp25';
var Comment25 = generateInvisible() + 'komen25' + generateInvisible();

var namagroup26 = 'groupp26';
var Comment26 = generateInvisible() + 'komen26' + generateInvisible();
