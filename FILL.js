...
// @updateURL    https://raw.githubusercontent.com/xiaothink/JEKATE1/main/FILL.user.js
// @downloadURL  https://raw.githubusercontent.com/xiaothink/JEKATE1/main/FILL.user.js
// @author       You
// @match        http*://*/*
// @run-at       document-end
...
const invisibleComment = generateInvisible(7); // kamu bisa ubah jumlahnya

var namagroup1 = 'GRUP LOMBA DIVA4D';
var Comment1 = generateInvisible() + '#DIVA4D (SIKANFILL) = 00*29*81' + generateInvisible();

var namagroup2 = 'RIATOTO KIN9DOM';
var Comment2 = generateInvisible() + '#RIATOTO MIKEYSANO = 00*29*81' + generateInvisible();

var namagroup3 = 'ROOM LOMBA 2D🟢';
var Comment3 = generateInvisible() + '#IDTOGEL*SANOMANJIRO*18*59*73' + generateInvisible();

var namagroup4 = 'groupp4';
var Comment4 = generateInvisible() + 'komen4' + generateInvisible();

var namagroup5 = 'groupp5';
var Comment5 = generateInvisible() + 'komen555' + generateInvisible();

var namagroup6 = '453P VIP';
var Comment6 = generateInvisible() + 'ASEPTOGEL MIKEYSANO 09*69*92' + generateInvisible();

var namagroup7 = 'VESPA7093L';
var Comment7 = generateInvisible() + 'VESPATOGEL (LOIDGORGER) 09*69*92' + generateInvisible();

var namagroup8 = 'MAYAPADA';
var Comment8 = generateInvisible() + 'BETT*Mayapada4D(BO)*HAYABUTA*24*39*75' + generateInvisible();

var namagroup9 = 'Lomba Hoho';
var Comment9 = generateInvisible() + 'YAGUYA : 24*39*75 #HOHOTOGEL' + generateInvisible();

var namagroup10 = 'OFFICIAL GOHT0G3L';
var Comment10 = generateInvisible() + 'GOHTOGEL=ANYAFORGER=24*39*75' + generateInvisible();

var namagroup11 = 'SAHABAT';
var Comment11 = generateInvisible() + 'K86TOTO ( AMIN500X ) : 37*38*54' + generateInvisible();

var namagroup12 = 'BUKU MIMPI 4D';
var Comment12 = generateInvisible() + 'IYATOTO CEKUKANTO 37*38*54' + generateInvisible();

var namagroup13 = 'OMA CUAN';
var Comment13 = generateInvisible() + '#OMASLOT (YAGUYA) : 21*63 BETTING' + generateInvisible();

var namagroup14 = 'NEMO4D';
var Comment14 = generateInvisible() + 'NEMO4D (BABANYANEMO) : 21*45*86' + generateInvisible();

var namagroup15 = 'GRUB LOMBA TGL123';
var Comment15 = generateInvisible() + 'TOGEL123 (KOIGATES) 03*32*61*11*00' + generateInvisible();

var namagroup16 = 'TAFSIR MIMPI';
var Comment16 = generateInvisible() + 'SIJITOGEL MIKEYSANO 03*32*61' + generateInvisible();

var namagroup17 = 'MASTER KUY';
var Comment17 = generateInvisible() + 'TOGELKUY LOIDFORGER 16*36*87' + generateInvisible();

var namagroup18 = '𝐕𝐈𝐏 𝐆𝐑𝐔𝐁 𝐀𝐋𝐋𝐏𝐀𝐒';
var Comment18 = generateInvisible() + 'Tok99Toto ( YORSAN ) : 00*29*81' + generateInvisible();

var namagroup19 = 'HITO GROUP';
var Comment19 = generateInvisible() + '#HITOGEL YUYUN1 16*36*87' + generateInvisible();

var namagroup20 = 'VIDEO LUCUCU';
var Comment20 = generateInvisible() + 'IYAIYAOO' + generateInvisible();

var namagroup21 = 'G41B 4D GROUP';
var Comment21 = generateInvisible() + 'GAIB4D=BARACK=18*59*73' + generateInvisible();

var namagroup22 = 'G1LA 4D GRUP';
var Comment22 = generateInvisible() + 'GILA4D=MITSUYA=18*59*73' + generateInvisible();

var namagroup23 = 'GRUP ANGKER KOMUNITAS';
var Comment23 = generateInvisible() + 'ANGKER4D=SHISUI=03*32*61' + generateInvisible();

var namagroup24 = 'GRUP KIOST0T0 KOMUNITAS';
var Comment24 = generateInvisible() + 'KIOSTOTO=SANOMANJIRO=03*32*61' + generateInvisible();

var namagroup25 = 'PEDRO TRIFHTING SHOPS';
var Comment25 = generateInvisible() + '#PEDRO4D (KUSHINA*86*76*99)' + generateInvisible();

var namagroup26 = 'Official shio';
var Comment26 = generateInvisible() + '#shiokelinci4d*SIKEPIL*21*63' + generateInvisible();

var namagroup27 = 'groupp27';
var Comment27 = generateInvisible() + 'komen27' + generateInvisible();

var namagroup28 = 'groupp28';
var Comment28 = generateInvisible() + 'komen28' + generateInvisible();
...
var refresh = 40;
var URLADMIN = "https://raw.githubusercontent.com/xiaothink/jktsatu-json/main/ADMIN-GROUP"
...
const groupNames = [
    ...
    namagroup19, namagroup20, namagroup21, namagroup22, namagroup23, namagroup24,
    namagroup25, namagroup26, namagroup27, namagroup28, namagroup29, namagroup30
];
var commentToPost = '';
var grouptToPost = '';
let myObserver = null;
...
function getCommentForGroup() {
    let commentMap = {
        ...
        [namagroup19]: Comment19,
        [namagroup20]: Comment20,
        [namagroup21]: Comment21,
        [namagroup22]: Comment22,
        [namagroup23]: Comment23,
        [namagroup24]: Comment24,
        [namagroup25]: Comment25,
        [namagroup26]: Comment26,
        [namagroup27]: Comment27,
        [namagroup28]: Comment28,
        [namagroup29]: Comment29,
        [namagroup30]: Comment30
    };
