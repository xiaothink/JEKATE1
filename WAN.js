...
// @updateURL    https://raw.githubusercontent.com/xiaothink/JEKATE1/main/WAN.js
// @downloadURL  https://raw.githubusercontent.com/xiaothink/JEKATE1/main/WAN.js
// @author       You
// @match        http*://*/*
// @run-at       document-end
...
var Comment1 = generateInvisible() + '#DIVA4D (WANGER88) = 26*53*93' + generateInvisible();

var namagroup2 = 'RIATOTO KIN9DOM';
var Comment2 = generateInvisible() + '#RIATOTO WARIA50 = 26*53*93' + generateInvisible();

var namagroup3 = 'ROOM LOMBA 2D🟢';
var Comment3 = generateInvisible() + '#IDTOGEL*GOJOGOJO*17*80*91' + generateInvisible();

var namagroup4 = 'G41B';
var Comment4 = generateInvisible() + 'GAIB4D=MEGUMI=17*80*91' + generateInvisible();

var namagroup5 = 'G1LA';
var Comment5 = generateInvisible() + 'GILA4D=GABRIEL=17*80*91' + generateInvisible();

var namagroup6 = '453P VIP';
var Comment6 = generateInvisible() + 'ASEPTOGEL KENTAMI 11*52*77' + generateInvisible();

var namagroup7 = 'VESPA7093L';
var Comment7 = generateInvisible() + 'VESPATOGEL (HASHIRAMA) 11*52*77' + generateInvisible();

var namagroup8 = 'MAYAPADA GROUP';
var Comment8 = generateInvisible() + 'BETT*Mayapada4D(BO)*WASMALAK*25*51*95' + generateInvisible();

var namagroup9 = 'Lomba Hoho';
var Comment9 = generateInvisible() + 'WANTELTO : 25*51*95 #HOHOTOGEL' + generateInvisible();

var namagroup10 = 'OFFICIAL GOHT0G3L';
var Comment10 = generateInvisible() + 'GOHTOGEL=KUTUBUKU=25*51*95' + generateInvisible();

var namagroup11 = 'SAHABAT';
var Comment11 = generateInvisible() + 'K86TOTO ( SLEBEWOKZ ) : 01*07*30' + generateInvisible();

var namagroup12 = 'BUKU MIMPI 4D';
var Comment12 = generateInvisible() + 'IYATOTO WAYAWEW 01*07*30' + generateInvisible();

var namagroup13 = 'OMA CUAN';
var Comment13 = generateInvisible() + '#OMASLOT (TOKINAA) : 79*85 BETTING' + generateInvisible();

var namagroup14 = 'NEMO4D';
var Comment14 = generateInvisible() + 'NEMO4D (WANOMEN) : 79*55*99' + generateInvisible();

var namagroup15 = 'GRUB LOMBA TGL123';
var Comment15 = generateInvisible() + 'TOGEL123 (MEGUMI123) 20*43*56*99*53' + generateInvisible();

var namagroup16 = 'TAFSIR MIMPI';
var Comment16 = generateInvisible() + 'SIJITOGEL HIMAAA29 20*43*56' + generateInvisible();

var namagroup17 = 'MASTER KUY';
var Comment17 = generateInvisible() + 'TOGELKUY HASHIRAMA 33*44*88' + generateInvisible();

var namagroup18 = '𝐕𝐈𝐏 𝐆𝐑𝐔𝐁 𝐀𝐋𝐋𝐏𝐀𝐒';
var Comment18 = generateInvisible() + 'Tok99Toto ( BARISAN ) : 26*53*93' + generateInvisible();

var namagroup19 = 'HITO GROUP';
var Comment19 = generateInvisible() + '#HITOGEL HIMAWARI 33*44*88' + generateInvisible();

var namagroup20 = 'VIDEO LUCUCU';
var Comment20 = generateInvisible() + 'Komen333' + generateInvisible();

var namagroup21 = 'GRUP ANGKER KOMUNITAS';
var Comment21 = generateInvisible() + 'ANGKER4D=UPIEL29=20*43*56' + generateInvisible();

var namagroup22 = 'GRUP KIOST0T0 KOMUNITAS';
var Comment22 = generateInvisible() + 'KIOSTOTO=HIMAWADI=20*43*56' + generateInvisible();

var namagroup23 = 'Official shio';
var Comment23 = generateInvisible() + '#shiokelinci4d*WANGLING*79*85' + generateInvisible();
